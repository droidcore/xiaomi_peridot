...
git clone -b lineage-23.0 https://github.com/droidcore/f6_proprietary_vendor_xiaomi_peridot.git vendor/xiaomi/peridot
...
git clone -b los --depth 1 https://github.com/droidcore/android_kernel_xiaomi_sm8635-modules.git kernel/xiaomi/sm8635-modules
